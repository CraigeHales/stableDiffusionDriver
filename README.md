...
ssh has X support. Just close those browsers if they show up.
...
There might be a drag'n'drop for external files into a tk window, but
it looked like it might not be a good use of time. I recently saw a
